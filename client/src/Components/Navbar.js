...
const NavBar = ({ location, dark }) => {
    ...
    if(dark) {
        return (
            <motion.div className="navbar" style={{ background: '#222335'}} variants={parent} initial="hidden" animate="show">
        ...
        return (
            <motion.div className="navbar" style={{ background: '#F2F3F8'}} variants={parent} initial="hidden" animate="show">
                <div className="container-fluid py-2 d-flex align-items-center justify-content-center justify-content-lg-between flex-column flex-lg-row px-0 px-lg-5">
                    ...
                    <div className="w-75 d-flex justify-content-around justify-content-lg-end align-items-center mt-4 mt-lg-0" style={{ color: '#222335' }} onMouseLeave={() => { setHoveredLink(location) }}>
                        ...
                        <motion.h5 className="mr-4 mb-0 pb-1" variants={children} style={(hoveredLink === 1 ? { borderBottom: '2.5px solid #222335', ...linkStyle} : { borderBottom: 0, ...linkStyle })} onMouseEnter={() => { setHoveredLink(1) }}>About</motion.h5>
                            <motion.h5 className="mr-4 mb-0 pb-1" variants={children} style={(hoveredLink === 2 ? { borderBottom: '2.5px solid #222335', ...linkStyle} : { borderBottom: 0, ...linkStyle })} onMouseEnter={() => { setHoveredLink(2) }}>Services</motion.h5>
                            <motion.h5 className="mr-4 mb-0 pb-1" variants={children} style={(hoveredLink === 3 ? { borderBottom: '2.5px solid #222335', ...linkStyle} : { borderBottom: 0, ...linkStyle })} onMouseEnter={() => { setHoveredLink(3) }}>Projects</motion.h5>
                        </div>
                    </div>
                </div>
            </motion.div>
