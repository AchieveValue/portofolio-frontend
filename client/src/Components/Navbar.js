    ...
    if(dark) {
        return (
            <motion.div className="navbar" style={{ background: '#222335'}} variants={parent} initial="hidden" animate="show" exit="hidden">
                <img className="d-block d-lg-none" style={{ position: 'fixed', top: '3%', left: '-3%', maxWidth: '8vh', zIndex: 3 }} src="https://i.ibb.co/272NT0y/Logo-Small-Square-removebg-preview.png" alt="Logo-Small-Square-removebg-preview" border="0"/>
