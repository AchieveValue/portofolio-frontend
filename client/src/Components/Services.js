        ...
        <>
            ...
            <motion.div className="" variants={parent} initial="hidden" animate="show">
                ...
                <div className='d-flex w-100 mx-auto flex-column flex-lg-row row justify-content-center align-items-center px-0 mt-5 mx-0 mb-5'>
                        {/* card 1 */}
                        <div className='align-self-stretch col-10 offset-1 col-md-5 col-lg-4 col-xl-2 offset-md-0 px-0 d-flex flex-column text-light pt-1 shadow-lg mr-5 mb-5' style={{ background: '#222335', borderRadius: '40px', height:'' }}>
                            ...
                            <div className='mx-3 pb-5 h-75' style={{ borderBottom: '2px solid rgba(255, 255, 255, 0.5)' }}>
                                    ...
                                    <div className='mb-2 px-3 mt-2'><h6 className='poppins font-weight-light'><i className='fas fa-check-circle mr-4' style={{ color: '#32ba7c' }}></i>Design implementation</h6></div>
                        ...
                        {/* card 2 */}
                        <div className='align-self-stretch offset-1 col-10 col-md-5 col-lg-4 col-xl-2 offset-md-0 px-0 d-flex flex-column text-light pt-1 shadow-lg mr-xl-5 mb-5' style={{ background: '#222335', borderRadius: '40px' }}>
                        ...
                        {/* card 3 */}
                        <div className='align-self-stretch offset-1 col-10 col-md-5 col-lg-4 col-xl-2 offset-lg-0 px-0 d-flex flex-column text-light pt-1 shadow-lg mr-xl-5 mb-5' style={{ background: '#222335', borderRadius: '40px' }}>
