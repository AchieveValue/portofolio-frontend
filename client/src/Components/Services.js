        ...
        <>
            ...
            <div className='d-flex w-100 mx-auto row justify-content-center align-items-center px-0 mt-5 mx-0 mb-5'>
                ...
                <div className='col-2 px-0 d-flex flex-column text-light pt-1 shadow-lg mr-5 mb-5' style={{ background: '#222335', borderRadius: '40px', height:'' }}>
                    <div className='d-flex align-items-center mb-3 w-75'><img src='https://i.ibb.co/rvXtFVN/wind-2.png' className='m-3' /><h5 className='rightenous text-center'>Front-end development</h5></div>
                ...
                <div className='col-2 px-0 d-flex flex-column text-light pt-1 shadow-lg mr-5 mb-5' style={{ background: '#222335', borderRadius: '40px' }}>
                    <div className='d-flex align-items-center mb-3 w-75'><img src='https://i.ibb.co/rvXtFVN/wind-2.png' className='m-3' /><h5 className='rightenous text-center'>Full website development</h5></div>
                ...
                {/* card 3 */}
                <div className='col-2 px-0 d-flex flex-column text-light pt-1 shadow-lg mr-5 mb-5' style={{ background: '#222335', borderRadius: '40px' }}>
                    <div className='d-flex align-items-center mb-3 w-75'><img src='https://i.ibb.co/rvXtFVN/wind-2.png' className='m-3' /><h5 className='rightenous text-center'>Back-end development</h5></div>
